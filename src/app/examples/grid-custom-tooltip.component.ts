...
export class GridCustomTooltipComponent implements OnInit {
  ...
  subTitle = `
  This demo shows how to create Regular & Custom Tooltips (<a href="https://github.com/slickclub/Angular-Slickgrid/wiki/Custom-Tooltip-(plugin)" target="_blank">Wiki docs</a>)
  <br/>
  <ul class="small">
