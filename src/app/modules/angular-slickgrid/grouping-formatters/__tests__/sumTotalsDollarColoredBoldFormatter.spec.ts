...
describe('sumTotalsDollarColoredBoldFormatter', () => {
  ...
  it('should display a negative sum in red with at least 2 decimals in parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = sumTotalsDollarColoredBoldFormatter(totals, { id: 'column1', field: 'column1', params: { displayNegativeWithParentheses: true } } as Column, {});
    const output2 = sumTotalsDollarColoredBoldFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, displayNegativeWithParentheses: true } } as Column, {});
  ...
  it('should display a sum number in correct color with at least 2 decimals when user provided minimum & maximum decimal count', () => {
    ...
    const output3 = sumTotalsDollarColoredBoldFormatter(totals, { id: 'column3', field: 'column3', params: { minDecimal: 3, displayNegativeWithParentheses: true } } as Column, {});
