...
export class GridFormatterComponent implements OnInit {
  ...
  subTitle = `
    Grid with Custom and/or included Slickgrid Formatters (<a href="https://github.com/slickgrid-stellar/Angular-Slickgrid/wiki/Formatters" target="_blank">Wiki docs</a>).
    <ul>
