...
describe('avgTotalsPercentageFormatter', () => {
  ...
  it('should display a negative percentage average with parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output1 = avgTotalsPercentageFormatter(totals, { id: 'column1', field: 'column1', params: { displayNegativeWithParentheses: true } } as Column, {});
    const output2 = avgTotalsPercentageFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, displayNegativeWithParentheses: true } } as Column, {});
  ...
  it('should display a percentage average number with user defined minimum & maximum decimal count', () => {
    ...
    const output3 = avgTotalsPercentageFormatter(totals, { id: 'column3', field: 'column3', params: { minDecimal: 3, displayNegativeWithParentheses: true } } as Column, {});
