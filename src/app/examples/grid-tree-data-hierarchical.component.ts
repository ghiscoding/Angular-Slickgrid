...
export class GridTreeDataHierarchicalComponent implements OnInit {
  title = 'Example 29: Tree Data <small> <span class="mdi mdi-file-tree mdi-27px"></span> (from a Hierarchical Dataset - <a href="https://github.com/slickgrid-stellar/Angular-Slickgrid/wiki/Tree-Data-Grid" target="_blank">Wiki</a>)</small>';
  subTitle = `<ul>
    ...
    <ul>
      <li>The Salesforce Theme was created with SASS and compiled in CSS (<a href="https://github.com/slickgrid-stellar/Angular-Slickgrid/blob/master/src/app/modules/angular-slickgrid/styles/slickgrid-theme-salesforce.scss" target="_blank">slickgrid-theme-salesforce.scss</a>), you can override any of its SASS variables</li>
