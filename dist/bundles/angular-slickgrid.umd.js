 ...
 * @suppress {checkTypes} checked by tsc
 */
var moment = moment___default__default || moment___default;
/**
 ...
 * @suppress {checkTypes} checked by tsc
 */
var moment$14 = moment___default__default || moment___default; // patch to fix rollup "moment has no default export" issue, document here https://github.com/rollup/rollup/issues/670
...
var ExportService = /** @class */ (function () {
     ...
     * @return {?}
     */
    ExportService.prototype.getFormattedRegularRow = function (columns, row, itemObj) {
        var /** @type {?} */ idx = 0;
        var /** @type {?} */ rowOutputString = '';
        var /** @type {?} */ delimiter = this._exportOptions.delimiter;
        var /** @type {?} */ format = this._exportOptions.format;
        var /** @type {?} */ exportQuoteWrapper = this._exportQuoteWrapper || '';
        var /** @type {?} */ columnHeaders = this._columnHeaders || [];
     ...
     * @return {?}
     */
    ExportService.prototype.getFormattedGroupeTitleRow = function (itemObj) {
     ...
     * @return {?}
     */
    ExportService.prototype.getFormattedGroupedTotalRow = function (itemObj) {
    ...
    ExportService.prototype.startDownloadFile = function (options) {
        ...
        if (options.format === FileType.csv) {
            outputData = new textEncoding.TextEncoder('utf-16be').encode(csvContent);
        }
        else {
...
var AngularSlickgridComponent = /** @class */ (function () {
    ...
    function AngularSlickgridComponent(controlAndPluginService, exportService, filterService, gridExtraService, gridEventService, resizer, sortService, translate, forRootConfig) {
        ...
        this.onAfterGridDestroyed = new core$1.EventEmitter();
        this.gridHeight = 100;
        this.gridWidth = 600;
    }
...
AngularSlickgridComponent.ctorParameters = function () { return [
    ...
    { type: SortService, },
    { type: core.TranslateService, },
    { type: undefined, decorators: [{ type: core$1.Inject, args: ['config',] },] },
]; };
AngularSlickgridComponent.propDecorators = {
    ...
    "onAfterGridDestroyed": [{ type: core$1.Output },],
...
exports.ɵs = MultipleSelectFilter;
exports.ɵu = SelectFilter;
exports.ɵt = SingleSelectFilter;
exports.ɵv = arrayToCsvFormatter;
exports.ɵw = checkboxFormatter;
exports.ɵx = checkmarkFormatter;
exports.ɵy = complexObjectFormatter;
exports.ɵz = dateIsoFormatter;
exports.ɵba = dateTimeIsoAmPmFormatter;
exports.ɵbd = dateTimeUsAmPmFormatter;
exports.ɵbc = dateTimeUsFormatter;
exports.ɵbb = dateUsFormatter;
exports.ɵbe = deleteIconFormatter;
