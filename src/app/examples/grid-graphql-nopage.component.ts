...
export class GridGraphqlWithoutPaginationComponent implements OnInit {
  ...
  subTitle = `
  Use basic GraphQL query with any external public APIs (<a href="https://github.com/slickgrid-stellar/Angular-Slickgrid/wiki/GraphQL" target="_blank">Wiki docs</a>).
  <ul>
