 ...
 * - "autoDropWidth" (default to False) when set will automatically adjust the dropdown with the same size as the select element width
 */
...
(function ($) {
    ...
    MultipleSelect.prototype = {
        ...
        open: function () {
            ...
            if (this.options.autoDropWidth && !this.options.width) {
