...
export class GridTreeDataParentChildComponent implements OnInit {
  title = 'Example 28: Tree Data <small> <span class="mdi mdi-file-tree mdi-27px"></span> (from a flat dataset with <code>parentId</code> references - <a href="https://github.com/slickgrid-stellar/Angular-Slickgrid/wiki/Tree-Data-Grid" target="_blank">Wiki</a>)</small>';
  subTitle = `<ul>
    ...
    <ul>
      <li>The Material Theme was created with SASS and compiled in CSS (<a href="https://github.com/slickgrid-stellar/Angular-Slickgrid/blob/master/src/app/modules/angular-slickgrid/styles/slickgrid-theme-material.scss" target="_blank">slickgrid-theme-material.scss</a>), you can override any of its SASS variables</li>
