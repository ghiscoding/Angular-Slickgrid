...
describe('sumTotalsDollarColoredFormatter', () => {
  ...
  it('should display a negative sum with parentheses instead of the negative sign when its input is negative', () => {
    ...
    const output2 = sumTotalsDollarColoredFormatter(totals, { id: 'column2', field: 'column2', params: { maxDecimal: 2, displayNegativeNumberWithParentheses: true } } as Column, {});
  ...
  it('should display a negative sum with parentheses when input is negative and "displayNegativeNumberWithParentheses" is enabled in the Formatter Options', () => {
    ...
    const output = sumTotalsDollarColoredFormatter(totals, columnDef, gridStub);
  ...
  it('should display an sum number with user defined minimum & maximum decimal count in his grid option', () => {
    ...
    const output1 = sumTotalsDollarColoredFormatter(totals, { id: 'column1', field: 'column1' } as Column, gridStub);
    const output2 = sumTotalsDollarColoredFormatter(totals, { id: 'column2', field: 'column2' } as Column, gridStub);
    const output3 = sumTotalsDollarColoredFormatter(totals, { id: 'column3', field: 'column3' } as Column, gridStub);
  ...
  it('should display a sum number in correct color with at least 2 decimals when user provided minimum & maximum decimal count', () => {
    ...
    const output3 = sumTotalsDollarColoredFormatter(totals, { id: 'column3', field: 'column3', params: { minDecimal: 3, displayNegativeNumberWithParentheses: true } } as Column, {});
