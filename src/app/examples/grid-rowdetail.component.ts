...
export class GridRowDetailComponent implements OnInit {
  ...
  subTitle = `
    Add functionality to show extra information with a Row Detail View, (<a href="https://github.com/slickgrid-stellar/Angular-Slickgrid/wiki/Row-Detail" target="_blank">Wiki docs</a>)
    <ul>
